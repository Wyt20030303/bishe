...
import com.pan.email.dao.UserMapper;
import com.pan.email.entity.DiscussPost;
import com.pan.email.entity.LoginTicket;
...
public class UserService implements CommunityConstant {
     ...
     * @return
     */
    public List<User> selectUserList(int offset, int limit, String userName, String userDept) {
        return userMapper.selectUserList(offset, limit, userName, userDept);
    }
    ...
    public Map<String, Object> register(User user) {
        ...
        if (StringUtils.isBlank(user.getUserDept())) {
            map.put("userDeptMsg", "所属部门不能为空");
            return map;
        }
